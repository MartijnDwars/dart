...
public class DartParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Dart");
  ...
  { 
    DartParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = DartParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DartParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DartParseControllerGenerated.class);
    }
  ...
  { 
    return DartParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
