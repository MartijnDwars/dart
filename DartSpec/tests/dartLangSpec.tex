...
\begin{grammar}
{\bf doStatement:}
    \DO{} statement \WHILE{} '(' expression ')' ';'% could do top level here
      .
 \end{grammar}
\begin{grammar}
{\bf switchStatement:}
...
\begin{grammar}
{\bf returnStatement:}
    \RETURN{} expression? ';' % could do top level here
    .
 \end{grammar}
\begin{grammar}
{\bf label:}
...
%      interfaceDefinitionOrInterfaceInjection;
 %     mixinApplication;
      ...
      % TODO: Something is wrong here! E.g. "var int x = 1, y = 2" cannot be parsed by the spec, but it should.
      % Why are staticFinalDeclarationList and variableDeclaration distinguished? Can we merge this, e.g. by
      % using initializedVariableDeclaration
