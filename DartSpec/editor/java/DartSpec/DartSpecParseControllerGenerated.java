...
public class DartSpecParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("DartSpec");
  ...
  { 
    DartSpecParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = DartSpecParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DartSpecParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DartSpecParseControllerGenerated.class);
    }
  ...
  { 
    return DartSpecParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
